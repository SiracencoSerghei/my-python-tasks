...
def get_employees_by_profession(path, profession):
    ...
    result = ''.join(list for list in employees_list).replace(profession, '')
...
#     return ' '.join(employees_list).replace(profession,'')
        

print(get_employees_by_profession('profession.txt', 'cook'))
