"""Напишіть регулярний вираз для функції find_all_emails, яка буде в тексті (параметр text) знаходити всі email та повертати список отриманих з тексту збігів.
...
def find_all_emails(text):
    result = re.findall(r'[A-Za-z]+[A-Za-z0-9_.]+@[A-Za-z]+\.[A-Za-z]{2,}\b', text)
    return result
